    ...
    <div style={{ position:'relative' }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .home-hero-inner { height: 100svh; min-height: 600px; }
          .hero-text-block { max-width: 100% !important; padding: 0 4px !important; }
          .hero-title { font-size: clamp(2rem, 8vw, 3rem) !important; }
          .hero-desc  { font-size: 1rem !important; margin-bottom: 24px !important; }
          .hero-cta-btns { flex-direction: column !important; gap: 10px !important; }
          .hero-cta-btns a, .hero-cta-btns button { width: 100% !important; justify-content: center !important; font-size: 0.95rem !important; padding: 13px 20px !important; }
          ...
          .dest-grid  { grid-template-columns: 1fr 1fr !important; gap: 14px !important; }
          .why-grid   { grid-template-columns: 1fr 1fr !important; gap: 14px !important; }
          .pkg-section-grid { grid-template-columns: 1fr !important; gap: 28px !important; }
          ...
          .cta-btns > * { width: 90% !important; justify-content: center !important; text-align: center !important; }
          .pkg-row { flex-direction: column !important; gap: 8px !important; padding: 18px 16px !important; }
          .pkg-row > div:last-child { text-align: left !important; }
      ...
      <div style={{ position:'relative', height:'100vh', overflow:'hidden' }}>
        ...
        {['←','→'].map((arrow, i) => (
          <button key={i} className="hero-slider-arrow"
      ...
      <section style={{ padding:'90px 0', background:'linear-gradient(135deg,#0a1628 0%,#1a1a2e 50%,#16213e 100%)', color:'white', position:'relative', overflow:'hidden' }}>
        ...
        <div className="container" style={{ position:'relative', zIndex:1 }}>
          <AnimatedSection>
            <div className='pkg-section-grid' style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'60px', alignItems:'center' }}>
              <div>
